            ...
            if (asin) {
                chrome.runtime.sendMessage({license: "1"}, function(response) {
                    ...
                    if (response.activeLicense == 1) {
                        iframe = '<iframe and seamless="seamless" scrolling="no" id="fba-wizard-frame" class="fba-wizard-frame" src="'+chrome.extension.getURL("html/fbawizard.html")+'?'+asin+'||'+rank+'||'+price+'||'+country+'"></iframe>';
                    } else {
